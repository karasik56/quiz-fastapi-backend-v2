...
from app.schemas.users import UserCreate, ShowUser, DeleteUser, GetUserByID
...
@user_router.get("/{user_id}", status_code=status.HTTP_200_OK, response_model=ShowUser)
@inject
